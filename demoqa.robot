...
Resource              ../resources/demoqa.resource
...
*Test Cases
UI Automation
  Log into bookstore's application with user emersonbraga and pass Paidoben123#
  At the book store page, add Git Pocket Guide to collection
  Validate that Git Pocket Guide is being displayed on collection
  Clean user's collection list
